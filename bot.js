...
client.on('ready', () => {
	...
	client.setInterval(() => {
		...
		client.guilds.find(guild => guild.id === '222055135071698944').me.setNickname(rand(Math.floor(Math.random() * 10) + 5)); //rand(Math.floor(Math.random() * 10) + 1)
    }, 5000);
});
